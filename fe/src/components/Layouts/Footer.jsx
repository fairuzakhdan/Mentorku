      ...
      >
        <GridItem colSpan={2} backgroundColor={'#fff'} p={5} rounded={'xl'} color={'textBlue'}>
          ...
          <Text fontSize="sm">
            ...
            terpercaya, yang siap membantu memajukan karier Anda. Dengan pengalaman dan keahlian
            yang luas, para mentor kami siap memberikan panduan praktis dan wawasan berharga untuk
        ...
        >
          ...
          <Flex columnGap={4} alignItems={'center'}>
            ...
            <Text>Jl. Mayor Syamsu, Garut, Jawa Barat </Text>
          </Flex>
          <Flex columnGap={4} alignItems={'center'}>
            <IconColor>
              <BsFillTelephoneFill />
